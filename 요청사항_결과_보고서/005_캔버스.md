...
**원인:**
- Firebase Console에서 **Firestore 데이터베이스가 생성되지 않음**

**해결:**
1. Firebase Console → Firestore Database
2. "데이터베이스 만들기" 클릭
3. 테스트 모드 선택 → 위치 선택 (asia-northeast3 서울) → 사용 설정

---

### 오류 4: Firestore PERMISSION_DENIED
...
**원인:**
- Firestore **보안 규칙이 설정되지 않음** (기본값이 모든 접근 차단)
